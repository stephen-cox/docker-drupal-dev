...
<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER['SERVER_PROTOCOL'].' 404 Not Found');die();}?>
{
  ...
  "files": {
    "apache1": {
      "display" : "Apache Error - Drupal",
      "path"    : "\/var\/log\/apache2\/drupal-error.log",
      "refresh" : 5,
      "max"     : 10,
      "notify"  : true,
      "format"  : {
    ...
    "apache2": {
      "display" : "Apache Access - Drupal",
      "path"    : "\/var\/log\/apache2\/drupal-access.log",
      "refresh" : 0,
      "max"     : 10,
      "notify"  : false,
      "format"  : {
    ...
    "apache3": {
      "display" : "Apache Error - Drupal SSL",
      "path"    : "\/var\/log\/apache2\/drupal-ssl-error.log",
      "refresh" : 5,
      "max"     : 10,
      "notify"  : true,
      "format"  : {
    ...
    "apache4": {
      "display" : "Apache Access - Drupal SSL",
      "path"    : "\/var\/log\/apache2\/drupal-ssl-access.log",
      "refresh" : 0,
      "max"     : 10,
      "notify"  : false,
      "format"  : {
